...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.post_date'
        db.add_column('wizardcms_page', 'post_date', models.DateField(null=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Page.post_date'
        db.delete_column('wizardcms_page', 'post_date')
