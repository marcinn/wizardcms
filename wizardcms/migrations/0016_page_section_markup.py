...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageSection.markup'
        db.add_column('wizardcms_pagesection', 'markup', models.CharField(default='W', max_length=1))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PageSection.markup'
        db.delete_column('wizardcms_pagesection', 'markup')
