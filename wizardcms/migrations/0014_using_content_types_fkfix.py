...
class Migration:
    ...
    def forwards(self, orm):
        db.alter_column('wizardcms_node', 'content_type_id', models.ForeignKey(orm['contenttypes.ContentType'], null=False))
    
    
    def backwards(self, orm):
        db.alter_column('wizardcms_node', 'content_type_id', models.ForeignKey(orm['contenttypes.ContentType'], null=True))
