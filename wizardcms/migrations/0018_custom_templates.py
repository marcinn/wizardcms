...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Template.path'
        db.add_column('wizardcms_template', 'path', models.CharField(max_length=255, null=True, blank=True))
        
        # Changing field 'Page.introduction'
        db.alter_column('wizardcms_page', 'introduction', models.TextField(null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Template.path'
        db.delete_column('wizardcms_template', 'path')
        
        # Changing field 'Page.introduction'
        db.alter_column('wizardcms_page', 'introduction', models.TextField(blank=True))
    ...
    models = {
        ...
        'wizardcms.pagesection': {
            ...
            'markup': ('models.CharField', [], {'default': "'W'", 'max_length': '1'}),
            'page': ('models.ForeignKey', ['Page'], {}),
