...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.introduction'
        db.add_column('wizardcms_page', 'introduction', models.TextField(blank=True, null=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Page.introduction'
        db.delete_column('wizardcms_page', 'introduction')
