...
class Migration:
    ...
    def forwards(self, orm):
        # Adding field 'Node.display_order'
        db.add_column('wizardcms_node', 'display_order', models.PositiveIntegerField(default=0))
        
    
    def backwards(self, orm):
        # Deleting field 'Node.display_order'
        db.delete_column('wizardcms_node', 'display_order')
