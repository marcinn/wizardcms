...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.content_type'
        db.add_column('wizardcms_node', 'content_type', models.ForeignKey(orm['contenttypes.ContentType'], null=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Node.content_type'
        db.delete_column('wizardcms_node', 'content_type_id')
