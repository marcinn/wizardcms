...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('wizardcms_category', (
            ('symbol', models.CharField(max_length=64)),
            ('description', models.CharField(max_length=255, null=True, blank=True)),
            ('id', models.AutoField(primary_key=True)),
            ('name', models.CharField(max_length=255)),
        ))
        db.send_create_signal('wizardcms', ['Category'])
        
        # Adding field 'Page.category'
        db.add_column('wizardcms_page', 'category', models.ForeignKey(orm.Category, related_name='pages', null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('wizardcms_category')
        
        # Deleting field 'Page.category'
        db.delete_column('wizardcms_page', 'category_id')
