...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Link'
        db.create_table('wizardcms_link', (
            ('node_ptr', orm['wizardcms.link:node_ptr']),
            ('url', orm['wizardcms.link:url']),
        ))
        db.send_create_signal('wizardcms', ['Link'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Link'
        db.delete_table('wizardcms_link')
