...
class Migration:
    ...
    def forwards(self, orm):
        db.alter_column('wizardcms_pagesection', 'display_order', models.PositiveIntegerField(null=False))
    
    
    def backwards(self, orm):
        db.alter_column('wizardcms_pagesection', 'display_order', models.PositiveIntegerField(null=True))
